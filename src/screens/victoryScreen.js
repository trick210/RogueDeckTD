class VictoryScreen {
  ...
  constructor(wave) {    
    ...
    this.victoryText = new PIXI.Text('Victory', {fontFamily: 'Arial', fontSize: 144, fill: 'yellow', align: 'center', stroke: 'black', lineJoin: "bevel", strokeThickness: 5});
    this.waveText = new PIXI.Text("You killed the boss in " + wave + " waves", {fontFamily: 'Arial', fontSize: 72, fill: 'white', align: 'center', stroke: 'black', lineJoin: "bevel", strokeThickness: 5});
