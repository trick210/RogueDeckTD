  ...
  _createClass(Bump, [{
    ...
    */
    ...
    value: function hitTestPoint(point, sprite) {
      ...
      if (shape === "rectangle") {
        ...
        left = sprite.gx - sprite.xAnchorOffset;
      ...
      if (shape === "circle") {
        ...
        var _vx = point.x - sprite.gx - sprite.width / 2 + sprite.xAnchorOffset,
            _vy = point.y - sprite.gy - sprite.height / 2 + sprite.yAnchorOffset,
    ...
    */
    ...
    value: function hitTestCircleRectangle(c1, r1) {
      ...
      let A = {
        x: r1x - r1.xAnchorOffset,
        y: r1y - r1.yAnchorOffset,
      }

      let B = {
        x: r1x + r1.width - r1.xAnchorOffset,
        y: r1y - r1.yAnchorOffset,
      }

      let C = {
        x: r1x + r1.width - r1.xAnchorOffset,
        y: r1y + r1.height - r1.yAnchorOffset,
      }
      ...
      collision = this.hitTestPoint(p, r1) ||
        (distToSegment(p, A, B) < c1.radius) ||
        (distToSegment(p, B, C) < c1.radius) ||
        (distToSegment(p, C, D) < c1.radius) ||
        (distToSegment(p, D, A) < c1.radius);
    ...
    value: function circleRectangleCollision(c1, r1) {
      ...
      let A = {
        x: r1x - Math.abs(r1.halfWidth) - r1.xAnchorOffset,
        y: r1y - Math.abs(r1.halfHeight) - r1.yAnchorOffset,
      }
    ...
    */
    ...
    value: function hit(a, b) {
      ...
      function circleVsCircle(a, b) {
        ...
        if (!react) {
          return hitTestCircle(a, b, global);
        }
